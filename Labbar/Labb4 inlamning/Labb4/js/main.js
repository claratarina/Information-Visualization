...
async function run() {
    ...
    function display(svg, nodes, links) {
        ...
        var simulation = d3.forceSimulation(nodes)
            ...
            .force("x", d3.forceX().strength(0.001).x(0.5 * width)) // Attraction towards the horizontal center
            .force("y", d3.forceY().strength(0.001).y(0.5 * height)); // Attraction towards the vertical center
